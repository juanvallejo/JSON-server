...
// define UAS api constants
Globals.UAS_PORT					= 8080;			// port to post / request data to UAS Competition server
Globals.UAS_HOST 					= 'http://localhost';
