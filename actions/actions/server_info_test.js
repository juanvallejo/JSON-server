...
var ServerInfoTest = new Test('doesJSONServerGetServerInformation');

// set our test case's expected value
ServerInfoTest.expects('No server info available.');

// override run function
ServerInfoTest.run = function() {
	...
	var connection = this.modules.UasRequest.get('/api/interop/server_info');
